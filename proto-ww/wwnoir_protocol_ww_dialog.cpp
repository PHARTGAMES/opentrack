...
WWControls::WWControls()
{
    ...
    connect(ui.set_custom_location, &QAbstractButton::clicked, this, &WWControls::set_custom_location);
}

void WWControls::doOK()
{
    s.b->save();
    close();
}

void WWControls::doCancel()
{
    close();
}

void WWControls::selectDLL()
{
...
void WWControls::set_custom_location()
{
